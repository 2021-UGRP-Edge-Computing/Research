...
def main():
    ...
    increase_delta = float(input("Input time slot increasing size:(float) 3")) # 3
    ...
    ref_gpu= float(input("Cooperation Reference gpu temperature:51"))   # 51
    gpu_test_num = int(input("Test number of Cooperation Reference gpu temperature:( at least 1) 5")) # 5
