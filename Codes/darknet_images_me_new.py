...
def main():
    ...
    for i in range(test_num):
        ...
        #instant_ff = open("lab/result1/instant_fps_list" + str(i+1)+".txt",'w')
        #for j in instant_fps:
        #    instant_ff.write(str(j)+" ")
        #instant_ff.close()

        #instant_tf = open("lab/result1/instant_time_list" + str(i+1)+".txt",'w')
    ...
    jetson.close()     
    tslist_file = open("lab/result3/Time_interval_list.txt",'w')
    for j in time_interval_list:
        tslist_file.write(str(j)+" ")
    tslist_file.close()

    fpslist_file = open("lab/result3/Fps_list.txt",'w')
